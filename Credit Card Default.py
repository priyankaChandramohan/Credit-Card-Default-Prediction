...
loaded_model = pickle.load(open('C:/Users/ankit/OneDrive/Desktop/streamlit_dashboard/trained_model_credit.pkl'
                                , 'rb'))
...
def main():
    ...
    bill_amt_sept = st.text_input('Amount of bill statement in September, 2005 (NT dollar)')
    bill_amt_aug = st.text_input('Amount of bill statement in August, 2005 (NT dollar)')
    bill_amt_jul = st.text_input('Amount of bill statement in July, 2005 (NT dollar)')
    bill_amt_jun = st.text_input('Amount of bill statement in June, 2005 (NT dollar)')
    bill_amt_may = st.text_input('Amount of bill statement in May, 2005 (NT dollar)')
    bill_amt_apr = st.text_input('Amount of bill statement in April, 2005 (NT dollar)')
    ...
    education_Graduate_School = st.radio("Education", ("0 = Graduate", "1 = High School", "2 = University"))
    ...
    marriage_Married = st.radio('Marriage Status',("0 = Married","1 = Un-Married"))
    ...
    pay_sept_1_ = st.radio("Repayment Status September", ("0 = paypal", "1 = payment delay for one month", "2 = payment delay for 2 months",
